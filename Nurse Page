...
public class EMR {
   ...
   private void initialize() {
      frmNurse = new JFrame();
      frmNurse.setTitle("Nurse");
      frmNurse.setBounds(0, 0, 1250, 799);
      ...
      frmNurse.getContentPane().add(panel_2);	
		panel_2.setLayout(null);
		
		tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(171, 47, 1135, 713);
		frmNurse.getContentPane().add(tabbedPane);
      ...
      frmNurse.getContentPane().add(tabbedPane_1);
